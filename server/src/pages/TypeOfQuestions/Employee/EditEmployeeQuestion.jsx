...
import {employees1Request, publicRequest} from '../../../utils/publicRequest.jsx'
import BeatLoader from "react-spinners/BeatLoader";

const EditEmployeeQuestion = () => {
...
useEffect(() => {
  ...
  const handleUpdateSubmit = async (e) => {
    ...
    try {
      await employees1Request.put(`/${category_of_question}${getTablePart}/${id}`, updateQuestion);
    } catch (error) {
...
export default EditEmployeeQuestion