...
import {faculty1Request, publicRequest} from '../../../utils/publicRequest.jsx'
import BeatLoader from "react-spinners/BeatLoader";

const EditFacultyQuestion = () => {
...
useEffect(() => {
  ...
  const handleUpdateSubmit = async (e) => {
    ...
    try {
      await faculty1Request.put(`/${category_of_question}${getTablePart}/${id}`, updateQuestion);
    } catch (error) {
...
export default EditFacultyQuestion